...
class nnUNetPredictor(object):
    ...
    def initialize_from_trained_model_folder(self, model_training_output_dir: str,
        ...
        for i, f in enumerate(use_folds):
            ...
            # nnU-Net checkpoints contain trusted trainer metadata and NumPy scalars in
            # addition to tensors. PyTorch 2.6 changed torch.load's default to
            # weights_only=True, which rejects that standard checkpoint structure.
