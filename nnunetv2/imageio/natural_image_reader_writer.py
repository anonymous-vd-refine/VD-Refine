...
class NaturalImage2DIO(BaseReaderWriter):
    ...
    def write_seg(self, seg: np.ndarray, output_fname: str, properties: dict) -> None:
        ...
        if os.environ.get('NNUNET_TIFF_ZLIB', '0') == '1' and output_fname.endswith('.tif'):
            tifffile.imwrite(output_fname, data=segmentation, compression='zlib')
        else:
            io.imsave(output_fname, segmentation, check_contrast=False)
