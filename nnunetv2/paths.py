...
│   ├── ...
"""
base = join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'data')
# Override the directories with the nnUNet_* environment variables.
nnUNet_raw = os.environ.get('nnUNet_raw', join(base, 'nnUNet_raw'))
nnUNet_preprocessed = os.environ.get('nnUNet_preprocessed', join(base, 'nnUNet_preprocessed'))
nnUNet_results = os.environ.get('nnUNet_results', join(base, 'nnUNet_results'))
